...
<head>
  ...
  <title>Call Contract Result decodeed</title>
       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Call Contract Decoded</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              <div class="box-body">
                  ...
                  <label  class="col-sm-2 control-label"><font color=red>*</font>Decoded:</label><br/>

                  <div class="col-sm-10">
                    <textarea class="form-control" rows="10" name="call_result" placeholder="cb_...">{{.Options}}</textarea>
                  </div>
                </div>
