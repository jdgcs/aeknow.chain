       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/transfertoken" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font color=red>*</font>Contract ID</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="contractID" placeholder="{{.PageTitle}}" value="{{.PageTitle}}">
                  </div>
                </div>
