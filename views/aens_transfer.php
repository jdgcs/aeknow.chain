       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Transfer AENS name</h3>
            </div>
            
            <div class="box-footer">
                  <form action="/dotransferaens" method="post">
                    <div class="input-group">
						<input type="hidden" name="aensname" class="form-control" value="{{.PageContent}}">
                      <input type="text" name="toaddress" placeholder="Transfer to... ak_ address" class="form-control">
