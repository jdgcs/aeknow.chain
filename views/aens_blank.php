			...
			<center>
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <i class="fa fa-btc margin-r-5"></i><b>Balance:</b> <a class="pull-right"/> AE</a>
                </li> 
                
                 <li class="list-group-item">
                  <i class="glyphicon glyphicon-retweet"></i> <b>AENS Bidding:</b> <a class="pull-right"/> </a>
                 
                </li>   
                
                <li class="list-group-item">
                  <i class="fa fa-calculator margin-r-5"></i><b>Nonce:</b> <a class="pull-right"/> </a>
                 
                </li> 
                
               <center> <a href="https://www.aeknow.org/address/wallet/" target="_blank">Transaction History</a></center>
       ...
       <div class="col-md-9">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li ><a href="/aens" >My AENS names</a></li>
              <li  class="active"><a href="/aensbidding" >My Bidding</a></li>
