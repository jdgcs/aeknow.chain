    ...
    <section class="content">
       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Call Contract</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/docall" method="POST">
              <div class="box-body">
	  ...
	  <select class="form-control" name="contract_name">
		{{.Options}}
		 ...
		 <button type="submit" class="btn btn-info pull-left">Call Contract</button>
		</div>
