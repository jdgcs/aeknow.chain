    ...
    <div class="box">		
		...
		<div class="col-md-9" style="margin-left:0px;padding-left:0px;">	 
		 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="title" placeholder="title" value="{{.PageTitle}}">
                  </div>
                </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="categories" placeholder="Categories" value="{{.PageCategories}}">
                  </div>
                </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tags" placeholder="Tags" value="{{.PageTags}}">
                  </div>
                </div>
          </div>       
        ...
        <script type="text/javascript">
            ...
            $(function() {
                testEditor = editormd("test-editormd", {
                    ...
                    imageFormats : ["jpg", "jpeg", "gif", "png", "bmp", "webp","mp4","avi","mkv"],
                    codeFold : true,
                    taskList : true,                   
