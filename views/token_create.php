...
<head>
  ...
  <title>Create AEX-9 Token</title>
       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create AEX-9 Token</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/dodeploytoken" method="POST">
              <div class="box-body">
				   <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font color=red>*</font>Symbol</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="symbol" placeholder="such as AEG">
                  </div>
                </div> 
				  
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font color=red>*</font>Name</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font color=red>*</font>Decimals</label>
                  <div class="col-sm-10">
					  <div class="input-group">
                    <input type="text" class="form-control" name="decimals" placeholder="such as 18">                     
                     </div>
                  </div>
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label"><font color=red>*</font>Total Supply</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="total_supply" placeholder="total supply of the token.">
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label"><font color=red>*</font>Contrac Name</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="contract_name" value="aex9.aes" readonly="readonly">
                  </div>
                </div>
                			
                 
                  
		 <button type="submit" class="btn btn-info pull-left">Create Token</button>
		</div>
