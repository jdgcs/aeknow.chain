    ...
    <section class="content">
       ...
       <div class="col-md-9">
		<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Decode Contract Call Result</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/dodecode" method="POST">
              <div class="box-body">
	  ...
	  <select class="form-control" name="contract_name">
		{{.Options}}
				  ...
				  <div class="form-group">
                  <label  class="col-sm-2 control-label"><font color=red>*</font>Content:</label>

                  <div class="col-sm-10">
                    <textarea class="form-control" rows="10" name="call_result" placeholder="cb_..."></textarea>
                  </div>
                </div>
				  
                  
		 <button type="submit" class="btn btn-info pull-left">Decode Call</button>
		</div>
